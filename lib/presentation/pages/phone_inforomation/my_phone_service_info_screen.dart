...
class MyPhoneServiceInfoScreen extends StatefulWidget {
  const MyPhoneServiceInfoScreen({Key? key}) : super(key: key);

  @override
  _MyPhoneServiceInfoScreenState createState() => _MyPhoneServiceInfoScreenState();
}

class _MyPhoneServiceInfoScreenState extends State<MyPhoneServiceInfoScreen> {
                              ...
                              child: Column(
                                children: [
                                  ...
                                  getExpandedCard(
                                      ...
                                      body: """Команда перехода *555*9911# Команда проверки остатка пакетов *505#, *604#. На тарифе можно досрочно обновить пакеты по тарифу набрав команду *2200# - с баланса спишется абонентская плата и все пакеты по тарифу обновятся."""
                                  ),
                                  ...
                                  getExpandedCard(
                                      ...
                                      body: """Если на балансе недостаточно средств для списания 4х недельной абонентской платы, в зависимости от состояния баланса будет списываться до 20 сомов в день за пакет минут и SMS внутри сети, а также пакет интернета на сутки, если на балансе:

...
class AllTariffsScreen extends StatefulWidget {
  const AllTariffsScreen({Key? key}) : super(key: key);

  @override
  _AllTariffsScreenState createState() => _AllTariffsScreenState();
}

class _AllTariffsScreenState extends State<AllTariffsScreen> {

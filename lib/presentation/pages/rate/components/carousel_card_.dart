        ...
        children: [
          ...
          RichText(
            text: const TextSpan(children: [
              TextSpan(text: '40 ГБ', style: TextStyle(color: Colors.black, fontSize: 12, fontWeight: FontWeight.w600)),
              TextSpan(
                  text: ' интернета',
                  style: TextStyle(color: Color.fromRGBO(144, 144, 144, 1), fontSize: 12, fontWeight: FontWeight.w400)),
            ]),
          ),
          const SizedBox(height: 5),
          RichText(
            text: const TextSpan(children: [
              TextSpan(text: '15 ГБ', style: TextStyle(color: Colors.black, fontSize: 12, fontWeight: FontWeight.w600)),
              TextSpan(
                  text: ' IVI',
                  style: TextStyle(color: Color.fromRGBO(144, 144, 144, 1), fontSize: 12, fontWeight: FontWeight.w400)),
            ]),
          ...
          RichText(
            text: const TextSpan(children: [
              TextSpan(
                  text: '40 мин', style: TextStyle(color: Colors.black, fontSize: 12, fontWeight: FontWeight.w600)),
              TextSpan(
          ...
          RichText(
            text: const TextSpan(children: [
              TextSpan(text: '8 ГБ', style: TextStyle(color: Colors.black, fontSize: 12, fontWeight: FontWeight.w600)),
              TextSpan(

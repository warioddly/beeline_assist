                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                color: currentChildPage > 0
                                    ? const Color.fromRGBO(226, 51, 56, 1)
                                    : const Color.fromRGBO(229, 70, 74, 0.5),
                                          ...
                                          child: Center(
                                            child: CarouselCard(
                                              ...
                                              onTap: () => Navigator.of(context).push(CupertinoPageRoute(
                                                  builder: (context) => const PhoneServiceInfoScreen())),
                                            ),
                                          ),
                                        ),
                                        Expanded(
